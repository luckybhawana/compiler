...
public class ConstantDefinitionsParser extends DeclarationsParser
{
     ...
     */
    public ConstantDefinitionsParser(SubsetCParserTD parent)
    {
        super(parent);
    }

    // Synchronization set for a constant identifier.
    private static final EnumSet<SubsetCTokenType> IDENTIFIER_SET =
    ...
    static final EnumSet<SubsetCTokenType> CONSTANT_START_SET =
        EnumSet.of(IDENTIFIER, INTEGER, REAL, PLUS, MINUS, STRING, SEMICOLON);

    // Synchronization set for the = token.
    private static final EnumSet<SubsetCTokenType> EQUALS_SET =
    ...
    private static final EnumSet<SubsetCTokenType> NEXT_START_SET =
        DeclarationsParser.TYPE_START_SET.clone();
    static {
