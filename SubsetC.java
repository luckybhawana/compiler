 ...
 * <h1>SubsetC</h1>
 *
 * <p>Compile or interpret a SubsetC source program.</p>
 *
 */
public class SubsetC
{
    ...
    public SubsetC(String operation, String filePath, String flags)
    {
        try {
            ...
            boolean lines         = flags.indexOf('l') > -1;
            boolean assign = flags.indexOf('a') > -1;
            boolean fetch = flags.indexOf('f') > -1;
            boolean call = flags.indexOf('c') > -1;
            boolean returnn = flags.indexOf('r') > -1;
    ...
    private static final String USAGE =
        "Usage: SubsetC execute|compile " + FLAGS + " <source file path>";
